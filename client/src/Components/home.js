...
function Home() {
  ...
  const notify = () => {
    toast("Unable to connect To whatsapp");
  };
  ...
  return (
    <div>
      <div class="main">
        <h1 align="center" class="margin">
          Send messages by whatsapppp
        </h1>
        <div class="mainbox">
          <div class="box1">
            <button onClick={getQRCode} ref={btn} class=" btn btn-success">
          ...
          <div class="box2">
            <div>
              <p>Choose the country you want :</p>
              <select
              ...
              <br />
              <button onClick={secondPage} class="btn btn-success">
                Press to get numbers
              </button>
            </div>
          </div>
        </div>
